...
//    private lateinit var tvLoadingData:TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        articleList = arrayListOf<ArticlesModel>()
                ...
                if(snapshot.exists()){
                    ...
                    mAdapter.setOnItemClickListner(object : articleAdapter.onItemClickListner{
                        override fun onItemClick(postion: Int) {
                            ...
                            //Put extras
                            intent.putExtra("articleID",articleList[postion].articleId )
                            intent.putExtra("articleTitle",articleList[postion].title )
                            intent.putExtra("articleContent",articleList[postion].content )
                            intent.putExtra("articleImage",articleList[postion].imageUrl )
                            intent.putExtra("articleType",articleList[postion].type )
